    ...
    function Ba(K) {
        ...
        function Ja(a, e, g, p, l) {
            ...
            if (h) {
                ...
                u = Math.atan2(x, u) - p;
                u +=
                    u > Math.PI ? -2 * Math.PI : u < -Math.PI ? 2 * Math.PI : 0;
                u = Math.abs(u);
                e.diff = Math.acos(
                ...
                'multires' != z
                    ? (ca || (ca = a.createBuffer()),
                      ...
                      'cubemap' == z
                          ...
                          : m.width <= L
                          ? (a.uniform1i(
                                a.getUniformLocation(c, 'u_splitImage'),
                                0
                            ),
                            a.texImage2D(
                                y,
    ...
    function Ba(s, k) {
                ...
                if (-1 < c && !0 !== b.ignoreGPanoXMP) {
                    var d = n.substring(c, n.indexOf('</x:xmpmeta>') + 12),
                        e = function (a) {
                            ...
                            0 <= d.indexOf(a + '="')
                                ? ((b = d.substring(
                                      d.indexOf(a + '="') + a.length + 2
                                  )),
                                  (b = b.substring(0, b.indexOf('"'))))
                                : 0 <= d.indexOf(a + '>') &&
                                  ((b = d.substring(
                                      d.indexOf(a + '>') + a.length + 1
                                  )),
                                  (b = b.substring(0, b.indexOf('<'))));
        ...
        function ua(a) {
            if (ha && G) {
                ...
                n =
                    (360 *
                        Math.atan(
                            (Math.tan((b.hfov / 360) * Math.PI) * f) / n
                        )) /
                    Math.PI;
                n =
                    (((180 *
        ...
        function m(a) {
            var f = O[a],
                n = Math.min(
                    1,
                    Math.max(
                        (Date.now() - f.startTime) / 1e3 / (f.duration / 1e3),
                        0
                    )
                ),
                n =
        ...
        function H(a) {
            ...
            var f,
                c,
                d =
                    'haov vaov vOffset northOffset horizonPitch horizonRoll'.split(
                        ' '
                    );
            aa = [];
            ...
            b.avoidShowingBackground &&
                ...
                (d = Math.min(
                    ...
                    (360 *
                        Math.atan(
                            (Math.tan(
                                ((b.maxPitch - b.minPitch) / 360) * Math.PI
                            ) /
                                a.height) *
                                a.width
                        )) /
        ...
        var da = this,
            ...
            Va = {
                ...
                capturedKeyNumbers: [
                    16, 17, 27, 37, 38, 39, 40, 61, 65, 68, 83, 87, 107, 109,
                    173, 187, 189,
                ],
                friction: 0.15,
                strings: {
